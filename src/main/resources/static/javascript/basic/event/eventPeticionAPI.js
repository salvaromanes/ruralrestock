...
function mapearEvento(event){
    return `<tr>
        ...
        <td>
            <button type="button" class="btn btn-primary" onclick="eliminarEvento('${event.nombre}')">
        ...
        <td>
            <button type="button" class="btn btn-primary" onclick="crearEventoDesdePeticion('${event.nombre}')">
...
function eliminarEvento(nombreEvento) {
    fetch('http://localhost:8080/api/event/deleteRequest/' + nombreEvento, {
        method: 'DELETE',
    })
    .then(response => {
        if (response.ok) {
...
function crearEventoDesdePeticion(nombreEvento) {
    fetch('http://localhost:8080/api/event/createFromPeticion/' + nombreEvento, {
        method: 'POST',
    })
    .then(response => {
        if (response.ok) {
